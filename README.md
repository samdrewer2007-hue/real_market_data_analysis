...
These results, however, are only based on a relatively short historical sample, so all annualised figures should be interpreted as scaled estimates rather than accurate long-term data.